...
const AccordionComponent = (props = {}) => {
  const { onOpen, onClose, initialAccordion, animate, headProps = {} } = props;
        ...
        >
          {close => (
            <>
              ...
              <button onClick={close} data-testid="close-by-content">
                close me
              </button>
            </>
          )}
...
describe('Accordion ui component tests', () => {
  describe('Accordion functionality tests', () => {
    ...
    it('Should show accordion panel on click Tab', () => {
      ...
      fireEvent.click(getByTestId('accordion-1'));
      expect(accordionSwitcher).toContainElement(
        getByTestId('accordionPanel-1'),
      );

      fireEvent.click(getByTestId('accordion-2'));
      expect(accordionSwitcher).toContainElement(
        getByTestId('accordionPanel-2'),
      );
  ...
  describe('Accordion props tests', () => {
    it('Should add class to element', () => {
      const { getByTestId } = render(
        AccordionComponent({ initialAccordion: 'accordion-1' }),
      );
    ...
    it('Should import exported module', () => {
      const { getByTestId } = render(
        AccordionComponent({ animate: false, initialAccordion: 'accordion-1' }),
      );
