          ...
          <div id="slider" className="slider loaded" data-testid="carousel">
            <div className="wrapper" data-testid="carousel-wrapper">
              <div className="slides" data-testid="carousel-slides">
                ...
                <span className="slide active" data-page="1">
                  Slide 2
                </span>
                <span className="slide" data-page="2">
                  Slide 3
                </span>
                <span className="slide" data-page="2">
                  Slide 4
                </span>
                <span className="slide" data-page="3">
                  Slide 5
                </span>
              </div>
            </div>
            ...
            <ul className="dots" data-testid="carousel-dots">
              <li
                ...
                data-testid="carousel-dot-item"
                data-dot-index="1"
              >
                1
              </li>
              <li className="dots-item" data-dot-index="2">
                2
              </li>
              <li className="dots-item" data-dot-index="3">
                3
              </li>
            </ul>
          </div>
