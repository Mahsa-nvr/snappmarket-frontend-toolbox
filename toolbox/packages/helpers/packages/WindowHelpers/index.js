 ...
 * @returns {boolean}
 */
export const isMobile = (agent = navigator.userAgent) => {
 ...
 * @function
 * @name scrollTo
 * @description scroll to passed offset
 * @param offset
 */
 ...
 * @function
 * @name isBot
 * @description Check if visitor is bot or not
 * @param agent
 * @returns {boolean}
 */
export const isBot = agent =>
  /bot|googlebot|crawler|spider|robot|crawling|baidu|bing|msn|teoma|slurp|yandex/i.test(
    agent,
  );
 ...
 * @param element
 */
export const goToElement = element => {
 ...
 * @function
 * @name getHostName
 * @description Returns location host name spliced
 * @returns {string[]}
 */
export const getHostName = () => window.location.hostname.split('.');
